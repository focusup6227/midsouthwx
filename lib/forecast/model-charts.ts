...
const F = {
  ...
  dewp2m: { key: 'dewp2m', label: '2 m Dewpoint', unit: '°F', min_fhr: 0 },
  wind10m: { key: 'wind10m', label: '10 m Wind', unit: 'kt', min_fhr: 0 },
  ...
  t850: { key: 't850', label: '850 hPa Temp', unit: '°C', min_fhr: 0 },
...
export const MODEL_CATALOG: { models: ModelDef[]; regions: RegionDef[] } = {
  models: [
    { key: 'gfs', label: 'GFS 0.25°', fhr_max: 84, fhr_step: 3, fields: [F.t2m, F.dewp2m, F.wind10m, F.mslp, F.cape, F.apcp, F.t850, F.hgt500] },
    { key: 'nam', label: 'NAM 12 km', fhr_max: 60, fhr_step: 3, fields: [F.t2m, F.dewp2m, F.wind10m, F.mslp, F.cape, F.apcp, F.t850] },
