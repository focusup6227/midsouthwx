// Self-contained service-client + withHealthLog helper. Mirrors the
// supabase.ts shipped with every other edge function so the deploy bundle
// doesn't need to follow parent-folder imports.
