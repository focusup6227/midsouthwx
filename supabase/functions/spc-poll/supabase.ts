...
// Edge-function health telemetry wrapper. Times the call, sniffs `ok` from
// the JSON response body, and writes one row to public.function_runs via the
// log_function_run RPC. Failures here are swallowed — telemetry must never
// crash the function. Pair with the /health dashboard.
